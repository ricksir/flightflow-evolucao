...
- fechado tecnicamente o ciclo final de aceitação dos PRs **#36–#41 e #43**: scroll proporcional da Rota Processada sem término visual precoce, correções de sobreposição e destaque quente de campos atualizados, Mission Rail V9 recolhível com ganho real de área útil, compactação do shell superior, Temporal Deck inferior sem caixotes internos e estabilização determinística do teste de playback/restart; o PR documental **#42** foi fechado sem merge ao revelar 1 flaky/retry no gate e foi substituído por esta sincronização posterior; baseline funcional `28b572f25527628f5db110f2f2765010b6f772ba`, quality gate pós-merge **#149**, **699/699 Node + 115/115 Playwright**, com zero `failed`/`flaky`/`retry`/`timeout`/`AssertionError`/`not ok`/`SPATIAL_EQ_DIAG`, housekeeping **#44** concluído e nenhum PR aberto; permanece pendente apenas a revalidação humana final antes de release, sem abertura automática de V12;
