...
test('APP complexo usa Fixo Saída como limite operacional e não traça linha até ADES remoto', async ({ page }) => {
  ...
  await expect(page.locator('#ffrpTitle')).toContainText('GLO7634 · SBBR → KMCO');
  ...
  await expect(page.locator('#ffrpSubtitle')).toContainText('rota declarada sem quadro PONTOS/ETIM');
